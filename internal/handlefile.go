...
//打开文件 自动创建目录
//go:linkname OpenFile github.com/jingyanbin/core/basal.OpenFile
...
//打开文件 自动创建目录
//go:linkname OpenFileB github.com/jingyanbin/core/basal.OpenFileB
...
//文件是否存在
//go:linkname IsExistBy github.com/jingyanbin/core/basal.IsExistBy
...
//文件或文件夹是否存在
//go:linkname IsExist github.com/jingyanbin/core/basal.IsExist
...
// 文件夹是否存在
//go:linkname IsExistFolder github.com/jingyanbin/core/basal.IsExistFolder
...
// 文件是否存在
//go:linkname IsExistFile github.com/jingyanbin/core/basal.IsExistFile
...
//go:linkname NewHandleFile github.com/jingyanbin/core/basal.NewHandleFile
func NewHandleFile(flag int, perm os.FileMode) *HandleFile {
	return &HandleFile{flag: flag, perm: perm}
}

//go:linkname OpenHandleFile github.com/jingyanbin/core/basal.OpenHandleFile
