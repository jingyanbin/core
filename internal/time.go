...
//	@return bool
//
//go:linkname IsLeapYear github.com/jingyanbin/core/datetime.IsLeapYear
...
//	@return bool
//
//go:linkname IsDoubleMonth github.com/jingyanbin/core/datetime.IsDoubleMonth
...
//	@return int 天数
//
//go:linkname MonthDayNumber github.com/jingyanbin/core/datetime.MonthDayNumber
...
//
//go:linkname DateClockToFormat github.com/jingyanbin/core/datetime.DateClockToFormat
...
//	@return string 日期时间字符串
//
//go:linkname DateClockToYmdHMS github.com/jingyanbin/core/datetime.DateClockToYmdHMS
...
//	@return err 错误
//
//go:linkname DateClockToUnix github.com/jingyanbin/core/datetime.DateClockToUnix
func DateClockToUnix(year, month, day, hour, min, sec int, zone tz.TimeZone) (unix int64, yDay int, daySecond int, err error) {
	...
	if err != nil {
		err = NewError("date clock to unix error check failed: %v, %v", DateClockToYmdHMS(year, month, day, hour, min, sec), err)
		return
	}
...
//	@return err 错误
//
//go:linkname FormatToUnix github.com/jingyanbin/core/datetime.FormatToUnix
...
//	@return err 错误
//
//go:linkname YmdHMSToUnix github.com/jingyanbin/core/datetime.YmdHMSToUnix
...
//	@return daySecond 一年中第几秒
//
//go:linkname UnixToDateClock github.com/jingyanbin/core/datetime.UnixToDateClock
...
//	@return err 错误
//
//go:linkname FormatToDateClock github.com/jingyanbin/core/datetime.FormatToDateClock
func FormatToDateClock(s, formatter string, extend bool) (year, month, day, hour, min, sec int, err error) {
	defer Exception(func(stack string, e error) {
		err = NewError("format to date clock error exception: %v, %v \n%v", s, formatter, stack)
	})
	...
	for i := 0; i < length; {
		...
		if c == '%' {
			...
			default:
				err = NewError("format to date clock error char: %v, %v, %v", c, c2, formatter)
				return
			}

			if !found {
				err = NewError("format to date clock error time: %v, %v", s, formatter)
				return
			}
			jump = 0
			i += 2
			...
			if !extend {
				...
				if (fnd && byt != c) || !fnd {
					err = NewError("format to date clock error separator: %v, %v", s, formatter)
					return
				}
			}
			jump += 1
	...
	err = checkDateClock(year, month, day, hour, min, sec)
	if err != nil {
		err = NewError("format to date clock error check failed: %v, %v", s, err)
	}
	return
}
...
//	@return week 星期 1-7
//
//go:linkname UnixWeekdayA github.com/jingyanbin/core/datetime.UnixWeekdayA
...
//	@return week 星期 0-6
//
//go:linkname UnixWeekdayB github.com/jingyanbin/core/datetime.UnixWeekdayB
...
//	@return wkn 第几周 1-53
//
//go:linkname UnixYearWeekNumAByISO github.com/jingyanbin/core/datetime.UnixYearWeekNumAByISO
...
//	@return int64 天数
//
//go:linkname UnixDayNumber github.com/jingyanbin/core/datetime.UnixDayNumber
...
//	@return error 错误
//
//go:linkname UnixPreClock github.com/jingyanbin/core/datetime.UnixPreClock
...
//	@return error 错误
//
//go:linkname UnixNextClock github.com/jingyanbin/core/datetime.UnixNextClock
...
//	@return error 错误
//
//go:linkname UnixNextWeekDayA github.com/jingyanbin/core/datetime.UnixNextWeekDayA
...
//	@return error 错误
//
//go:linkname UnixNextWeekDayB github.com/jingyanbin/core/datetime.UnixNextWeekDayB
...
//	@return error 错误
//
//go:linkname UnixFutureWeekDayA github.com/jingyanbin/core/datetime.UnixFutureWeekDayA
...
//	@return error 错误
//
//go:linkname UnixFutureWeekDayB github.com/jingyanbin/core/datetime.UnixFutureWeekDayB
...
//	@return int64 秒级时间戳
//
//go:linkname UnixWeekStartTimeA github.com/jingyanbin/core/datetime.UnixWeekStartTimeA
...
//	@return int64 秒级时间戳
//
//go:linkname UnixWeekEndTimeA github.com/jingyanbin/core/datetime.UnixWeekEndTimeA
...
//	@return error 错误
//
//go:linkname UnixWeekDayStartTimeA github.com/jingyanbin/core/datetime.UnixWeekDayStartTimeA
...
//	@return error 错误
//
//go:linkname UnixWeekAnyTimeA github.com/jingyanbin/core/datetime.UnixWeekAnyTimeA
...
//	@return error 错误
//
//go:linkname UnixYearAnyTime github.com/jingyanbin/core/datetime.UnixYearAnyTime
...
//	@return error 错误
//
//go:linkname UnixMonthAnyTime github.com/jingyanbin/core/datetime.UnixMonthAnyTime
...
//	@return error 错误
//
//go:linkname UnixDayAnyTime github.com/jingyanbin/core/datetime.UnixDayAnyTime
...
//	@return int64 秒级时间戳
//
//go:linkname UnixYearStartTime github.com/jingyanbin/core/datetime.UnixYearStartTime
...
//	@return int64 秒级时间戳
//
//go:linkname UnixYearEndTime github.com/jingyanbin/core/datetime.UnixYearEndTime
...
//	@return int64 秒级时间戳
//
//go:linkname UnixMonthStartTime github.com/jingyanbin/core/datetime.UnixMonthStartTime
...
//	@return int64 秒级时间戳
//
//go:linkname UnixMonthEndTime github.com/jingyanbin/core/datetime.UnixMonthEndTime
...
//	@return int64 秒级时间戳
//
//go:linkname UnixDayStartTime github.com/jingyanbin/core/datetime.UnixDayStartTime
...
//	@return int64 秒级时间戳
//
//go:linkname UnixDayEndTime github.com/jingyanbin/core/datetime.UnixDayEndTime
...
//	@return int64 秒级时间戳
//
//go:linkname UnixHourStartTime github.com/jingyanbin/core/datetime.UnixHourStartTime
...
//	@return int64 秒级时间戳
//
//go:linkname UnixMinStartTime github.com/jingyanbin/core/datetime.UnixMinStartTime
...
//	@return error 错误
//
//go:linkname UnixDayStartTimeNext github.com/jingyanbin/core/datetime.UnixDayStartTimeNext
...
//	@return error 错误
//
//go:linkname UnixHourStartTimeNext github.com/jingyanbin/core/datetime.UnixHourStartTimeNext
...
//	@return error 错误
//
//go:linkname UnixBetweenWeekTimeA github.com/jingyanbin/core/datetime.UnixBetweenWeekTimeA
func UnixBetweenWeekTimeA(unix int64, startTime, endTime string, zone tz.TimeZone) (bool, error) {
	startNums, endNums := NewNextNumber(startTime).Numbers(), NewNextNumber(endTime).Numbers()
	if len(startNums) != 4 || len(endNums) != 4 {
		return false, NewError("time error: %s, %s", startTime, endTime)
	}
...
//	@return error 错误
//
//go:linkname UnixBetweenMonthTime github.com/jingyanbin/core/datetime.UnixBetweenMonthTime
...
//	@return error 错误
//
//go:linkname UnixBetweenHourTime github.com/jingyanbin/core/datetime.UnixBetweenHourTime
...
//	@return error 错误
//
//go:linkname UnixBetweenHourTimeEx github.com/jingyanbin/core/datetime.UnixBetweenHourTimeEx
func UnixBetweenHourTimeEx(unix int64, startHms string, endHms string, zone tz.TimeZone) (bool, int64, int64, error) {
	startNums, endNums := NewNextNumber(startHms).Numbers(), NewNextNumber(endHms).Numbers()
	if len(startNums) != 3 || len(endNums) != 3 {
		return false, 0, 0, NewError("time error: %s, %s", startHms, endHms)
	}
	startUnix, err := UnixDayAnyTime(unix, startNums[0], startNums[1], startNums[2], zone)
	if err != nil {
...
var hmsLenErr = NewError("hms string len error")
...
//	@return err 错误
//
//go:linkname HmsToClock github.com/jingyanbin/core/datetime.HmsToClock
...
//	@return error 返回错误
//
//go:linkname HmsToSec github.com/jingyanbin/core/datetime.HmsToSec
...
//	@return error 错误
//
//go:linkname ClockToSec github.com/jingyanbin/core/datetime.ClockToSec
...
//
//go:linkname UnixToFormat github.com/jingyanbin/core/datetime.UnixToFormat
...
//
//go:linkname UnixToYmdHMS github.com/jingyanbin/core/datetime.UnixToYmdHMS
...
//	@return bool 是否同一天
//
//go:linkname UnixSameDay github.com/jingyanbin/core/datetime.UnixSameDay
...
//	@return bool 是否同一周
//
//go:linkname UnixSameWeekA github.com/jingyanbin/core/datetime.UnixSameWeekA
...
//	@return bool 是否同一月
//
//go:linkname UnixSameMonth github.com/jingyanbin/core/datetime.UnixSameMonth
...
//	@return int 天数
//
//go:linkname UnixDiffMonth github.com/jingyanbin/core/datetime.UnixDiffMonth
