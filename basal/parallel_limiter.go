...
const (
	PARALLEL_ACQUIRE_SUCCESS PARALLEL_ACQUIRE_STATE = 0 //正常
	PARALLEL_ACQUIRE_MAX     PARALLEL_ACQUIRE_STATE = 1 //达到最大并发
	PARALLEL_ACQUIRE_TIMEOUT PARALLEL_ACQUIRE_STATE = 2 //超时
	PARALLEL_ACQUIRE_CLOSED  PARALLEL_ACQUIRE_STATE = 3 //关闭
)
